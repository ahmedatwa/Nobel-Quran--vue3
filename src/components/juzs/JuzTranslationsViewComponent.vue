...
import { useJuzStore, useSurahStore } from "@/stores";
import { TitleButtonsComponent, ButtonsActionListComponent } from "@/components"
    ...
    if (juzStore.selectedJuz) {
        ...
        if (currentJuz < 30) {
            ...
            if (next) {
                ...
                if (next.verses.length) juzStore.selectedJuz = next
            }
    ...
    <v-container fluid>
        ...
        <v-row justify="center" :align="'center'">
            <v-col cols="12" class="text-center">
                <v-btn prepend-icon="mdi-arrow-left-bottom" class="me-2" variant="outlined" @click="getPrevJuz">{{
                ...
                <v-btn prepend-icon="mdi-arrow-right-bottom" class="me-2" variant="outlined" @click="getNextJuz">{{
