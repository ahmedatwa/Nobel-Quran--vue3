...
import { ref } from 'vue';
import { JuzReadingViewComponent, JuzTranslationsViewComponent } from '@/components';
...
<template>
    <v-card v-show="selected" class="ma-2" :elevation="1"
        :id="`quran-reader-content-juz${juzStore.selectedJuz?.juz_number}`" :loading="juzStore.isLoading"
